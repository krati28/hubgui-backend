...
public class CustomerDetailsController {
    ...
    @CrossOrigin
    public ApiResponse<List<CustomerDetails>> listOnlyCustomers(){
      return new ApiResponse<>(HttpStatus.OK.value(), "Customers fetched successfully", service.findAllCustomerslist());
    }
